/*
  ...
  #
  TEF6686 lithio 1.02 patch 2.22
  by VoXiTPro
  changes: 
...
static const uint8_t DSP_INIT[] PROGMEM =
{
  ...
  0x11, 0x1B, 0x66, 0xE7, 0x67, 0x0B, 0x67, 0x1A, 0x67, 0x29, 0x68, 0x87, 0x68, 0x99, 0x68, 0xA7, 0x68, 0xB2, // End of LutByteValues
  0x03, 0x1C, 0x00, 0x00,                                           // End of Patch 2.22
...
static const uint8_t INIT_DX1[] PROGMEM =
{
 /*TEF6686_add_and_improved_settings by eustake*/
  ...
  0x11, 0x20, 0x17, 0x01, 0x00, 0x01, 0x03, 0xE8, 0x00, 0x00, 0x03, 0xE8, 0x00, 0x01, 0x00, 0x78, 0x0A, 0xF0,  // FM 23 Set_NoiseBlanker           (1, 1, 1000, 0, 1000, 1, 120, 2800)
  ...
  0x0B, 0x20, 0x29, 0x01, 0x00, 0x01, 0x00, 0xB4, 0x00, 0x78, 0x01, 0xDC,                                      // FM 41 Set_Softmute_ Mod          (1, 1, 180, 120, 220) 
  0x09, 0x20, 0x2A, 0x01, 0x00, 0x01, 0x00, 0x64, 0x00, 0xDC,                                                  // FM 42 Set_Softmute_Level         (1, 1, 100, 220)          
  0x09, 0x20, 0x2B, 0x01, 0x00, 0x01, 0x01, 0xF4, 0x03, 0xE8,                                                  // FM 43 Set_Softmute_Noise         (1, 1, 500, 1000)       
  0x09, 0x20, 0x2C, 0x01, 0x00, 0x01, 0x01, 0xF4, 0x03, 0xE8,                                                  // FM 44 Set_Softmute_Mph           (1, 1, 500, 1000)       
  ...
  0x09, 0x20, 0x35, 0x01, 0x00, 0x01, 0x03, 0x20, 0x00, 0xC8,                                                  // FM 53 Set_Highcut_Noise          (1, 1, 800, 200)        
  0x09, 0x20, 0x36, 0x01, 0x00, 0x01, 0x03, 0x20, 0x00, 0xC8,                                                  // FM 54 Set_HighCut_Mph            (1, 1, 800, 200)        
  ...
  0x0B, 0x20, 0x3D, 0x01, 0x00, 0x01, 0x00, 0xD2, 0x00, 0x5A, 0x02, 0x58,                                      // FM 61 Set_Stereo_Mod             (1, 1, 210, 90, 600)        
  0x09, 0x20, 0x3E, 0x01, 0x00, 0x01, 0x01, 0xA4, 0x00, 0xDC,                                                  // FM 62 Set_Stereo_Level           (1, 1, 420, 220)            
  ...
  0x09, 0x20, 0x48, 0x01, 0x00, 0x01, 0x01, 0xF4, 0x00, 0xF0,                                                  // FM 72 Set_StHiBlend_Level        (1, 1, 500, 240)           
  0x09, 0x20, 0x49, 0x01, 0x00, 0x01, 0x00, 0x50, 0x00, 0x64,                                                  // FM 73 Set_StHiBlend_Noise        (1, 1, 80, 100)           
  0x09, 0x20, 0x4A, 0x01, 0x00, 0x01, 0x00, 0x50, 0x00, 0x64,                                                  // FM 74 Set_StHiBlend_Mph          (1, 1, 80, 100)         
  ...
  0x07, 0x20, 0x5A, 0x01, 0x00, 0x80, 0x00, 0x14,                                                              // FM_Set_StBandBlend_Time          (1, 80, 20)
  ...
  0x05, 0x20, 0x56, 0x01, 0x03, 0x84,                                                                          // FM 86 Set_Bandwidth_Options      (1, 900)
   /*AM*/
  0x05, 0x21, 0x0B, 0x01, 0x03, 0xFC,                                                                          // AM_Set_RFAGC (1, 1020)                                                          
...
static const uint8_t INIT_DX2[] PROGMEM =
{
 /*TEF6686_add_and_improved_settings by eustake*/
  0x05, 0x20, 0x14, 0x01, 0x00, 0x01,                                                                          // FM 20 Set_MphSuppression         (1, 1)
  0x05, 0x20, 0x16, 0x01, 0x00, 0x01,                                                                          // FM 22 Set_ChannelEqualizer       (1, 1)
...
static const uint8_t INIT_DX3[] PROGMEM =
{
 /*TEF6686_add_and_improved_settings by eustake*/
  0x05, 0x20, 0x14, 0x01, 0x00, 0x01,                                                                          // FM 20 Set_MphSuppression         (1, 1)
  0x05, 0x20, 0x16, 0x01, 0x00, 0x01,                                                                          // FM 22 Set_ChannelEqualizer       (1, 1)
  ...
  0x07, 0x20, 0x17, 0x01, 0x00, 0x01, 0x03, 0xE8,                                                              // FM 23 Set_NoiseBlanker           (1, 1, 1000) 
  0x09, 0x20, 0x18, 0x01, 0x01, 0x2C, 0x01, 0x2C, 0x00, 0xFA,                                                  // FM 24 Set_NoiseBlanker_Options   (1, 300, 300, 250)
  0x11, 0x20, 0x26, 0x01, 0xFF, 0xEC, 0xFF, 0xE2, 0xFF, 0xD8, 0xFF, 0xCE, 0xFF, 0xC4, 0xFF, 0xC4, 0xFF, 0xC4,  // FM 38 Set_LevelStep              (1, -20, -30, -40, -50, -60, -60, -60)
  0x0B, 0x20, 0x28, 0x01, 0x00, 0x78, 0x01, 0xF4, 0x00, 0x0A, 0x00, 0x14,                                      // FM 40 Set_Softmute_Time          (1, 120, 500, 10, 20)   
  0x0B, 0x20, 0x29, 0x01, 0x00, 0x01, 0x00, 0xD2, 0x00, 0x8C, 0x01, 0x04,                                      // FM 41 Set_Softmute_ Mod          (1, 1, 210, 140, 260)
  0x09, 0x20, 0x2A, 0x01, 0x00, 0x01, 0x00, 0x64, 0x00, 0xDC,                                                  // FM 42 Set_Softmute_Level         (1, 1, 100, 220)         
  0x09, 0x20, 0x2B, 0x01, 0x00, 0x01, 0x03, 0x20, 0x00, 0x64,                                                  // FM 43 Set_Softmute_Noise         (1, 1, 800, 100)    
  0x09, 0x20, 0x2C, 0x01, 0x00, 0x01, 0x03, 0x20, 0x00, 0x64,                                                  // FM 44 Set_Softmute_Mph           (1, 1, 800, 100)    
  0x07, 0x20, 0x2D, 0x01, 0x00, 0x01, 0x01, 0x90,                                                              // FM 45 Set_Softmute_Max           (1, 1, 400)
  0x0B, 0x20, 0x32, 0x01, 0x00, 0xC8, 0x05, 0xDC, 0x00, 0x0A, 0x00, 0x50,                                      // FM_Set_HighCut_Time              (1, 200, 1500, 10, 80)            
  0x0B, 0x20, 0x33, 0x01, 0x00, 0x01, 0x00, 0x64, 0x00, 0x82, 0x03, 0xE8,                                      // FM 51 Set_Highcut_Mod            (1, 1, 100, 130, 1000) 
  0x09, 0x20, 0x34, 0x01, 0x00, 0x01, 0x00, 0xC8, 0x01, 0x2C,                                                  // FM 52 Set_Highcut_Level          (1, 1, 200, 300)        
  0x09, 0x20, 0x35, 0x01, 0x00, 0x01, 0x03, 0x20, 0x00, 0x64,                                                  // FM 53 Set_Highcut_Noise          (1, 1, 800, 100)       
  0x09, 0x20, 0x36, 0x01, 0x00, 0x01, 0x03, 0x20, 0x00, 0x64,                                                  // FM 54 Set_HighCut_Mph            (1, 1, 800, 100)     
  0x07, 0x20, 0x37, 0x01, 0x00, 0x01, 0x09, 0x60,                                                              // FM 55 Set_HighCut_Max            (1, 1, 2400)            
  0x07, 0x20, 0x38, 0x01, 0x00, 0x01, 0x27, 0x10,                                                              // FM 56 Set_Highcut_Min            (1, 1, 10000)          
  0x07, 0x20, 0x39, 0x01, 0x00, 0x01, 0x00, 0x78,                                                              // FM 57 Set_Lowcut_Max             (1, 1, 120)             
  0x07, 0x20, 0x3A, 0x01, 0x00, 0x01, 0x00, 0x1E,                                                              // FM 58 Set_Lowcut_Min             (1, 1, 30)
  0x05, 0x20, 0x3B, 0x01, 0x00, 0x01,                                                                          // FM_Set_HighCut_Options           (1, 1)                                       
  0x0B, 0x20, 0x3C, 0x01, 0x00, 0xC8, 0x05, 0xDC, 0x00, 0x14, 0x00, 0x50,                                      // FM 60 Set_Stereo_Time            (1, 200, 1500, 20, 80)       
  0x0B, 0x20, 0x3D, 0x01, 0x00, 0x01, 0x00, 0x64, 0x00, 0x1E, 0x03, 0xE8,                                      // FM 61 Set_Stereo_Mod             (1, 1, 100, 30, 1000)      
  0x09, 0x20, 0x3E, 0x01, 0x00, 0x01, 0x01, 0x2C, 0x01, 0x2C,                                                  // FM 62 Set_Stereo_Level           (1, 1, 300, 300)           
  0x09, 0x20, 0x3F, 0x01, 0x00, 0x01, 0x03, 0x20, 0x00, 0x64,                                                  // FM 63 Set_Stereo_Noise           (1, 1, 800, 100)         
  0x09, 0x20, 0x40, 0x01, 0x00, 0x01, 0x03, 0x20, 0x00, 0x64,                                                  // FM 64 Set_Stereo_Mph             (1, 1, 800, 100)       
  0x05, 0x20, 0x41, 0x01, 0x00, 0x01,                                                                          // FM 65 Set_Stereo_Max             (1, 1)                      
  0x07, 0x20, 0x42, 0x01, 0x00, 0x01, 0x01, 0x90,                                                              // FM 66 Set_Stereo_Min             (1, 1, 400)
  0x0B, 0x20, 0x46, 0x01, 0x01, 0xF4, 0x03, 0xE8, 0x00, 0x14, 0x00, 0x14,                                      // FM_Set_StHiBlend_Time            (1, 500, 1000, 20, 20)      
  0x0B, 0x20, 0x47, 0x01, 0x00, 0x01, 0x00, 0xF0, 0x00, 0x78, 0x03, 0xE8,                                      // FM_Set_StHiBlend_Mod             (1, 1, 240, 120, 1000)
  0x09, 0x20, 0x48, 0x01, 0x00, 0x01, 0x01, 0x90, 0x00, 0xF0,                                                  // FM 72 Set_StHiBlend_Level        (1, 1, 400, 240)   
  0x09, 0x20, 0x4A, 0x01, 0x00, 0x01, 0x00, 0x50, 0x00, 0x64,                                                  // FM_Set_StHiBlend_Mph             (1, 1, 80, 100)
  0x09, 0x20, 0x49, 0x01, 0x00, 0x01, 0x00, 0x50, 0x00, 0x64,                                                  // FM_Set_StHiBlend_Noise           (1, 1, 80, 100)              
...
static const uint8_t INIT_DX4[] PROGMEM =
{
  /*TEF6686_add_and_improved_settings by voxit*/
  ...
  0x07, 0x20, 0x38, 0x01, 0x00, 0x00, 0x27, 0x10,                                                             // FM 56 Set_Highcut_Min          (1, 0, 10000)                          default
  ...
  0x05, 0x20, 0x56, 0x01, 0x03, 0x84,                                                                         // FM 86 Set_Bandwidth_Options    (1, 900)
  /*AM*/
  0x07, 0x21, 0x0A, 0x01, 0x00, 0x01, 0x00, 0x1E,                                                              // AM_Set_Bandwidth (1, 1, 30)
  0x05, 0x21, 0x0B, 0x01, 0x03, 0xFC,                                                                          // AM_Set_RFAGC (1, 1020)                                                          
  0x0B, 0x21, 0x0E, 0x01, 0x00, 0x01, 0x00, 0x02, 0x04, 0xB0, 0x00, 0x03,                                      // AM_Set_CoChannelDet (1, 1, 2, 1200, 3)
  0x07, 0x21, 0x17, 0x01, 0x00, 0x01, 0x04, 0xB0,                                                              // AM_Set_NoiseBlanker (1, 1, 1200)       
  0x07, 0x21, 0x18, 0x01, 0x00, 0x01, 0x04, 0xB0,                                                              // AM Set_NoiseBlanker_Audio (1, 1, 1200)
    ...
    if (buff[buff_pos] != '\n' && buff_pos != SERIAL_BUFFER_SIZE - 1)
      ...
      switch (buff[0])
      {
        ...
        case 'Z':
          Serial.print('Z');
          if (buff[1] == '0') {
              dsp_write_data(INIT_DX1);
            Serial.print("0");
          } else if (buff[1] == '1') {
              dsp_write_data(INIT_DX2);
            Serial.print("1");
          } else if (buff[1] == '2') {
              dsp_write_data(INIT_DX3);
            Serial.print("2");
          } else if (buff[1] == '3') {
              dsp_write_data(INIT_DX4);
            Serial.print("3");
          } else {
            Serial.print("4");
          }
